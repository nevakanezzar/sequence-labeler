...
THEANO_FLAGS="device=gpu1,floatX=float32" python ../sequence-labeler-master/v2_sle_mixeddata.py e78.conf > e78.results

THEANO_FLAGS="device=gpu1,floatX=float32" python ../sequence-labeler-master/v2_sle_mixeddata.py e79.conf > e79.results
