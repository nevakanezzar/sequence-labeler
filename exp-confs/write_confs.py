...
conf_file_content = ["[config]",
                     "path_train = /home/skasewa/stuff/project/data/exp-data/train/wiki-roman/wrsc-"+code+".tsv",
                      "multiple = 1",
...
conf_file_content = ["[config]",
                     "path_train = /home/skasewa/stuff/project/data/exp-data/train/wiki-roman/fce-wrsc-"+code+".tsv",
                      "multiple = 1",
                     "path_dev = /home/skasewa/stuff/project/data/exp-data/dev/fce/fce-public.dev.original.tsv",
                     "path_test = /home/skasewa/stuff/project/data/exp-data/dev/fce/fce-public.dev.original.tsv:/home/skasewa/stuff/project/data/exp-data/test/fce/fce-public.test.original.tsv:/home/skasewa/stuff/project/data/exp-data/test/conll14-test0/nucle.test0.original.tsv:/home/skasewa/stuff/project/data/exp-data/test/conll14-test1/nucle.test1.original.tsv:/home/skasewa/stuff/project/data/exp-data/test/lang8/lang8-test.tsv",
                     "main_label = i",
                     ...
                     "min_word_freq = 1",
                     "max_batch_size = 256",
                     "save = /home/skasewa/stuff/project/models/downstream/"+code+"0a.model",
                     "load = ",
                     "random_seed = 420",
                     "crf_on_top = False",
                     "char_integration_method = attention",
...
for i, mult in enumerate(mults):
    batch_size = 256 if i<7 else 64
    conf_file_content = ["[config]",
                         "path_train = /home/skasewa/stuff/project/data/exp-data/train/fce/fce-public.train.original.tsv,/home/skasewa/stuff/project/data/exp-data/train/wiki-roman/wrsc-"+code+".tsv",
                         "multiple = "+str(mult),
                         "path_dev = /home/skasewa/stuff/project/data/exp-data/dev/fce/fce-public.dev.original.tsv",
                         "path_test = /home/skasewa/stuff/project/data/exp-data/dev/fce/fce-public.dev.original.tsv:/home/skasewa/stuff/project/data/exp-data/test/fce/fce-public.test.original.tsv:/home/skasewa/stuff/project/data/exp-data/test/conll14-test0/nucle.test0.original.tsv:/home/skasewa/stuff/project/data/exp-data/test/conll14-test1/nucle.test1.original.tsv:/home/skasewa/stuff/project/data/exp-data/test/lang8/lang8-test.tsv",
                         "main_label = i",
