...
#python ../sequence-labeler-master/sequence_labeling_experiment.py ${CODE}6.conf > ${CODE}6.results
python ../sequence-labeler-master/sequence_labeling_experiment.py ${CODE}7.conf > ${CODE}7.results
python ../sequence-labeler-master/sequence_labeling_experiment.py ${CODE}8.conf > ${CODE}8.results
python ../sequence-labeler-master/sequence_labeling_experiment.py ${CODE}9.conf > ${CODE}9.results
python ../sequence-labeler-master/sequence_labeling_experiment.py ${CODE}10.conf > ${CODE}10.results
